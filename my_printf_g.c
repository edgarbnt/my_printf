...
int get_g_sign(double nb, to_print_t *to_print)
{
...
char *my_printf_g_f(double nb, params_t *params, to_print_t *to_print)
{
...
char *my_printf_g_e(va_list list, params_t *params, to_print_t *to_print)
{
    int neg_e = 0;
    int i = 0;
...
int my_printf_g(va_list list, params_t *params)
{
    ...
    to_print.arg = my_printf_g_e(list, params, &to_print);
